...
In addition to the missing values, it is important to note that while some of the attributes have been read in as continous attibutes such as Pclass, Sibsp and Parch. Since these variables actually represent discrete characteristics of each passenger, changing them to be non-continuous will allow a more representative analysis.
...
knitr::kable(df, caption = "Attribute Null & NA Counts")
